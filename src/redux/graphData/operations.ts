...
export const editUserThunk = createAsyncThunk<UserBody, UserBody>("editUserInfo", async (body, thunkApi) => {
	try {
...
export const editPhotoThunk = createAsyncThunk<UserBody, File>("editUserPhoto", async (file, thunkApi) => {
	try {
...
export const patchPassedQuiz = createAsyncThunk<PatchPassedQuizResponse, PatchPassedQuizRequest>(
	"user/patchPassedQuiz",
	async (body, thunkApi) => {
		try {
...
export const retakePassedQuiz = createAsyncThunk<RetakePassedQuizResponse, RetakePassedQuizRequest>(
	"user/retakePassedQuiz",
	async (body, thunkApi) => {
		try {
